         ...
         <tr>
            ...
            <td>
               <form action="" method="post" >
                  ...
                  <input type="number" style="border:none" name="update_quantity" min="1"  value="<?php echo $fetch_cart['quantity']; ?>" >
                  <input type="submit" value="update" class="p-2" style="border-radius:5px" name="update_update_btn">
               </form>   
            </td>
